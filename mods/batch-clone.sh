...
# Clone Channel (modid = channel) 
git clone https://github.com/USS-Shenzhou/Channel channel
...
# Clone 卡里普索的糖果工坊 (modid = ccw) 
git clone https://github.com/LNatit/CandyWorkshop ccw

# Clone 中键标点 (modid = middle_key_ping) 
git clone https://github.com/Anvil-Dev/MiddleKeyPing middle_key_ping

# Clone 山河同契 (modid = bonded_peaks) 
git clone https://github.com/Gu-ZT/bonded-peaks bonded_peaks

# Clone 最后的上勾拳 One Last Rising Uppercut (modid = olru) 
git clone https://github.com/MarbleGateKeeper/OneLastRisingUppercut olru

# Clone 铁砧工艺：猫+! (modid = nekoplus) 
git clone https://github.com/ZhuRuoLing/NekoPlus nekoplus
...
# Clone 更好的打雪仗3：重铸版 (modid = bsf3lite) 
