...
def write_team_info(team: Team, contest_name: str, contest_slug: str, workflow_template: str) -> None:
...
if __name__ == '__main__':
    ...
    contest_id, contest_slug = get_contest_id('TeaCon 2023')
    ...
    for team in team_list:
        if not team['ready']:
            ...
            continue
        write_team_info(team, 'TeaCon 2023', contest_slug, workflow_template)
